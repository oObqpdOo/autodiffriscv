...
#ifndef __SYNTHESIS__
#ifdef DEBUG_MUL_OPS
  printf("Update MUL latency - ");
  printf("mul_latency_out: %d and mul_latency_in: %d\n", *mul_latency_out, mul_latency_in);  
#endif
#endif
  }
}
...
#ifndef __SYNTHESIS__
#ifdef DEBUG_MUL_OPS
  printf("Update DIV latency - ");
  printf("div_latency_out: %d and div_latency_in: %d\n", *div_latency_out, div_latency_in);  
#endif
#endif
  }
}
...
#ifdef DEBUG_MUL_OPS
        printf("starting MUL\n");
        printf("mul_latency_in: %d \n", mul_latency_out);
        printf("mul_latency_out: %d \n", mul_latency_out);
#endif
#endif
