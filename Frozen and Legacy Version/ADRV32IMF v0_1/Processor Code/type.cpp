...
#ifdef FPU
    case 0b001: return I_TYPE; 	   //LOAD-FP
#else
    case 0b001: return OTHER_TYPE; //LOAD-FP
#endif
#ifdef AD
    case 0b010: return AD_S_TYPE;  //AD_S_TYPE
#else
...
#ifdef FPU
    case 0b001: return S_TYPE; 	   //STORE-FP
#else
...
#pragma HLS INLINE
  switch(opcl){
#ifdef FPU
    case 0b000: return R4_TYPE;    //MADD
    case 0b001: return R4_TYPE;    //MSUB
    case 0b010: return R4_TYPE;    //NMSUB
    case 0b011: return R4_TYPE;    //NMADD
...
#ifdef FPU
    case 0b100: return R_TYPE;     //SYSTEM
#else
...
type_t type(ap_uint<2> opch, ap_uint<3> opcl){
#pragma HLS INLINE
  switch(opch){
