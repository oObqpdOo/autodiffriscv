  ...
  switch(msize){
    ...
    case SW:
      ...
      data_mem->ad_data_mem_3[a2][ad_channel] = *rv2_3;
		...
		printf("VALUE WILL BE %d\n", (unsigned int)(*rv2_0 + (*rv2_1 << 8) + (*rv2_2 << 16) + (*rv2_3 << 24)));
#endif
#endif
      break;
    case 3:
	...
	case 0b110:
		...
		*rv2_3 = data_mem->ad_data_mem_3[a2][ad_channel];
				...
				printf("VALUES WILL BE %d (%x), %d (%x), %d (%x), %d (%x)\n", *rv2_0, *rv2_0, *rv2_1 << 8, *rv2_1 << 8, *rv2_2 << 16, *rv2_2 << 16, *rv2_3 << 24, *rv2_3 << 24);
				printf("REGISTER (%d) VALUE WILL BE %d (%x)\n", (unsigned int)*rd, (unsigned int)((*rv2_0 & 0xFF) + ((*rv2_1 << 8) & 0xFF00) + ((*rv2_2 << 16) & 0xFF0000) + ((*rv2_3 << 24) & 0xFF0000)), (unsigned int)((*rv2_0 & 0xFF) + ((*rv2_1 << 8) & 0xFF00) + ((*rv2_2 << 16) & 0xFF0000) + ((*rv2_3 << 24) & 0xFF000000)));
