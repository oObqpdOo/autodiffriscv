...
#ifndef __SYNTHESIS__
#ifdef DEBUG_MUL_OPS
  printf("mul_result_out in mul_execute_1(): %d \n", *mul_result_out);
#endif
#endif
}
...
#ifndef __SYNTHESIS__
#ifdef DEBUG_MUL_OPS
  printf("div_result_out in div_execute_1(): %d \n", *div_result_out);
#endif
#endif
}
...
#ifndef __SYNTHESIS__
#ifdef DEBUG_MUL_OPS
  printf("MUL passed from e1 to e2: %d \n", mul_result_in_float_int.i);
#endif
#endif
}
...
#ifndef __SYNTHESIS__
#ifdef DEBUG_MUL_OPS
  printf("DIV passed from e1 to e2: %d \n", div_result_in_float_int.i);
#endif
#endif
